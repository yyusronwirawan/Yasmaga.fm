  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col gap-5 w-full">
        <div className="w-[130px] h-[130px] rounded-lg mt-32 mx-auto overflow-hidden">
        ...
        <div className="flex flex-col gap-2 items-center">
          ...
          >
            {isActive ? <IoPlayOutline size={32} /> : <FaRegSquare  size={32} />} {/* Mengganti ikon dengan yang lebih sesuai */}
          </div>
        ...
        <div className="flex items-center w-full text-white gap-5 md:gap-10 mt-10">
          <div className="flex items-center justify-center gap-4 border border-white w-full py-2 rounded-[4px] cursor-pointer">
            <IoIosHeartEmpty />
        ...
        <div className="w-full bg-[#202020] rounded-lg flex items-center p-3 lg:px-20 lg:py-5 gap-3 lg:gap-20">
          <div className="min-w-20 w-20 h-20 rounded-lg overflow-hidden">
            <img src={bgBanner} alt="Mini Banner" />
          </div>
        ...
        <div className="flex flex-col items-center gap-4 mt-4 mb-10">
          {/* Menggunakan ikon SVG dari assets */}
